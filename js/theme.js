...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* ===== Inicializace =====
   * Počáteční aplikace tématu je řešena inline <script> v <head> (FE-6 FOUC fix).
   * Zde pouze synchronizujeme stav UI prvků (select, data-theme atribut).
   */
  const currentTheme = getSavedTheme();
  // Synchronizuj data-theme atribut (nezakládej nový <link> — head script už ho vytvořil)
