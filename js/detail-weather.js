...
(function () {
    ...
    // ── Shared i18n helper — reads from window.gpxI18n injected by layout_header.php.
    ...
    // ── Detekce jazyka ────────────────────────────────────────────────────────
    // Prefer the lang embedded in gpxI18n (server-resolved), fall back to cookie.
    function getLang() {
        if (window.gpxI18n && window.gpxI18n._lang) return window.gpxI18n._lang;
        try {
