...
> Verze 2026-05 &nbsp;|&nbsp; [English version](install-guide.md)
...
> **Bez Composeru:** Aplikace nevyžaduje `composer install` ani build nástroje (Node.js apod.). Po nahrání souborů funguje rovnou — i na sdíleném hostingu bez SSH přístupu.
...
- Podrobný rozbor konfigurace `.htaccess` (instalace na localhost i webhosting, Alias i VirtualHost) najdeš v návodu [htaccess-navod.md](htaccess-navod.md)
