...
/* ===================== WHERE podmínky ===================== */
$params_main = [];
$whereSql = buildFilterSQL($filterActive, $params_main, 't.');
...
";
$params_stats = [];
$whereStats   = buildFilterSQL($filterActive, $params_stats, 't.');
...
";
$params_chart = [];
$whereChart   = buildFilterSQL($filterActive, $params_chart, 't.');
